...
point_data:
  ...
  - Yuan-Source
  - Earth point
  location_description: On the medial side of the foot in the depression proximal
    and inferior to the head of the first metatarsal bone.
  location_notes: In the depression located by sliding the fingertip proximally over
    the side of the ball of the foot.
  ...
  indications:
    ...
    - atrophy disorder
    - disorders of the joints of the big toe and the head of the first metatarsal
      bone
  combinations:
  ...
  - condition: Pain of intestinal abscess
    ...
    - BL-25
    source: Great Compendium
  - condition: Abdominal distention, undigested food (in the stool) and drum distention
      with great fullness
    points:
    - SP-3
    - SP-4
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/SP-3_diagram.jpg
cssclasses:
- noyaml
---
