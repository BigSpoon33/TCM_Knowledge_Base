...
point_data:
  ...
  - Yuan-Source
  - Earth point
  location_description: At the wrist joint, on the radial side of flexor carpi ulnaris,
    in the depression at the proximal border of the pisiform bone.
  location_notes: i. The location of this point is normally given in relation to the
    crease of the wrist. Since wrist creases are a superficial and variable anatomical
    feature, it is better to locate this point in relation to the underlying pisiform
    bone; ii. When it is necessary to needle a patient in the prone position with
    the arms towards the head, this point may be located and needled on the ulnar
    side of flexor carpi ulnaris, very close to the tendon insertion; the needle is
    then directed beneath the tendon towards its radial side.
  ...
  - condition: Mania, desires to ascend to high places and sing, discards clothing
      and runs around
    points:
    - HE-7
    - ST-42
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/HE-7_diagram.jpg
cssclasses:
- noyaml
---
