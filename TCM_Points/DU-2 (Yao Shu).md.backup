...
point_data:
  ...
  location_notes: The sacro-coccygeal hiatus is located in-between the cornua of the
    sacrum and coccyx, in the depression inferior to the fourth sacral spinous process
    if this is palpable. Note, however, that the sacro-coccygeal hiatus may sometimes
    extend as high as the level of the third sacral foramina.
  ...
  - condition: Stiffness of the lumbar region and back with inability to bend to the
      side
    points:
    - DU-2
    - BL-13
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/DU-2_diagram.jpg
cssclasses:
- noyaml
---
