...
point_data:
  ...
  special_properties:
  - Meeting point of the Gall Bladder and Spleen channels
  - Front-Mu point of the Gall Bladder
  location_description: On the anterior chest wall, in the seventh intercostal space,
    directly below the nipple, 4 cun lateral to the midline.
  location_notes: First locate the costal cartilage of the second rib which is level
    with the sternal angle, locate the second intercostal space below it and then
    locate the seventh intercostal space, five spaces below that. In males the nipple
    lies in the fourth intercostal space.
  ...
  combinations:
  - condition: Indecisiveness due to Gall Bladder deficiency (with bitter taste and
      upward flowing qi)
    points:
    - GB-24
    - BL-19
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/GB-24_diagram.jpg
cssclasses:
- noyaml
---
