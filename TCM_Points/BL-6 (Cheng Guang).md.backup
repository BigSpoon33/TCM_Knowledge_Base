...
point_data:
  ...
  channel: Bladder
  special_properties: []
  location_description: 1.5 cun posterior to Wǔchù BL-5, 2.5 cun within the anterior
    hairline and 1.5 cun lateral to the midline.
  location_notes: i. To locate the anterior hairline if indistinct, see location note
    for Méichōng BL-3; ii. Note that the distance from the anterior hairline at the
    midline to Bǎihuì DU-20 is 5 cun.
  needling_method: Transverse insertion
  needling_depth: 0.5 to 1 cun
  needling_cautions:
  - according to several classical and modern texts, this point is contraindicated
    to moxibustion
  functions:
...
created: 2025-10-05
updated: 2025-10-05
banner: "TCM_Points_Images/BL-6_diagram.jpg"
cssclasses:
- noyaml
---
