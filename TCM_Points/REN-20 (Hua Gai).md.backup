...
category:
- Ren Mai (Conception Vessel) Channel Points
related: []
symptoms: []
patterns: []
western_conditions: []
...
point_data:
  ...
  special_properties: []
  location_description: On the midline of the sternum, level with the junction of
    the first intercostal space and the sternum.
  location_notes: First locate the costal cartilage of the second rib which is level
    with the sternal angle, then locate the first intercostal space above it.
  needling_method: Transverse insertion directed superiorly or inferiorly along the
    channel
  ...
  indications:
    ...
    other: []
  combinations:
  - condition: Shortness of breath and difficulty catching the breath with inability
      to speak
    points:
    - REN-20
    - REN-17
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/REN-20_diagram.jpg
cssclasses:
- noyaml
---
