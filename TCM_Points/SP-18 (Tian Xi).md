...
point_data:
  ...
  channel: None
  special_properties: []
  location_description: On the lateral side of the chest, in the fourth intercostal
    space, 6 cun lateral to the midline.
  location_notes: i. The intercostal spaces are most reliably counted downwards from
    the second intercostal space which lies immediately below the sternal angle. In
    males, the nipple almost invariably lies in the fourth intercostal space; ii.
    The six cun line is located two cun lateral to the mamillary line.
  needling_method: Transverse-oblique insertion along the intercostal space
  needling_depth: 0.5 to 1 cun
  needling_cautions:
  - perpendicular insertion, especially in thin patients, carries a substantial risk
    of inducing a pneumothorax.
  functions:
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/SP-18_diagram.jpg
cssclasses:
- noyaml
---
