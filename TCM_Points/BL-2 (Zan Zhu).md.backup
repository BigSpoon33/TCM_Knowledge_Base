...
point_data:
  ...
  channel: Bladder
  special_properties: []
  location_description: Superior to the inner canthus, in a depression on the eyebrow,
    close to its medial end.
  location_notes: Palpate laterally along the eyebrow from its medial end and feel
    for the hollow directly above Jīngmíng BL-1. This point is often found to be tender
    on palpation.
  needling_method: i. Transverse-oblique insertion inferiorly towards Jīngmíng BL-1
    for eye diseases; ii. Transverse lateral insertion to join with Yúyāo M-HN-6 for
    supraorbital pain; iii. Prick to bleed for heat disorders.
  needling_depth: None
  needling_cautions:
...
created: 2025-10-05
updated: 2025-10-05
banner: "TCM_Points_Images/BL-2_diagram.jpg"
cssclasses:
- noyaml
---
