...
point_data:
  ...
  location_description: On the midline, in the centre of the suprasternal fossa, 0.5
    cun superior to the suprasternal notch.
  location_notes: ''
  needling_method: i. Perpendicular insertion 0.3 cun; ii. With the neck extended
    (remove head pillow), needle first perpendicularly 0.2 to 0.3 cun, then direct
    the needle inferiorly along the posterior border of the manubrium of the sternum
    0.5 to 1 cun.
  needling_depth: 0.3 cun (perpendicular); 0.2 to 0.3 cun then 0.5 to 1 cun (along
    manubrium)
  needling_cautions:
  - This second method should not be attempted by practitioners without clinical experience
    under supervision.
  functions:
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/REN-22_diagram.jpg
cssclasses:
- noyaml
---
