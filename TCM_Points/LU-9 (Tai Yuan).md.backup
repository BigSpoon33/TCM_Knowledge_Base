...
point_data:
  ...
  - Shu-stream point
  - Yuan-source point
  - Earth point of the Lung channel
  - Hui-Meeting point of the Vessels
  location_description: At the wrist joint, in the depression between the radial artery
    and the tendon of abductor pollicis longus, level with Shénmén HE-7 (the proximal
    border of the pisiform bone).
  location_notes: 'The location of this point is normally given in relation to the
    crease of the wrist. Since wrist creases are a superficial and variable anatomical
    feature, it is better to locate this point in relation to the nearby pisiform
    bone: first locate Shénmén HE-7 at the lower (proximal) border of the pisiform
    bone, then find Tàiyuān LU-9 at the same level.'
  ...
  indications:
    ...
    - dyspnoea
    - shortness of breath
    - oppression and agitation of the chest with difficult breathing and inability
      to lie down
    digestive:
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/LU-9_diagram.jpg
cssclasses:
- noyaml
---
