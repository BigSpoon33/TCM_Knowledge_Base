...
point_data:
  ...
  special_properties: []
  location_description: On the chest, in the first intercostal space, 4 cun lateral
    to the midline (Huágài REN-20), on the mamillary line.
  location_notes: i. First locate the costal cartilage of the second rib which is
    level with the sternal angle, then locate the first intercostal space above it;
    ii. Note that in males the nipple lies in the fourth intercostal space; iii. Note
    that the intercostal space curves upwards laterally, so that Kùfáng ST-14 will
    lie superior to the level of Huágài REN-20.
...
created: 2025-10-05
updated: 2025-10-05
banner: TCM_Points_Images/ST-14_diagram.jpg
cssclasses:
- noyaml
---
