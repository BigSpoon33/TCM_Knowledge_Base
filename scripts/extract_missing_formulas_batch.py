...
def main():
    ...
    parser.add_argument("--pdf", default="Books/Bensky - Formulas and Strategies, 2nd Edition-1.pdf",
                        help="Path to Bensky Formulas PDF")
    parser.add_argument("--priority", type=int, choices=[1, 2, 3], 
                        help="Only extract formulas of this priority (1=highest)")
    parser.add_argument("--dry-run", action="store_true",
                        help="Show what would be extracted without actually doing it")
    parser.add_argument("--limit", type=int,
                        help="Limit number of formulas to extract")
    ...
    print(f"\n{'='*60}")
    print(f"BATCH FORMULA EXTRACTION")
    print(f"{'='*60}")
