...
def create_pathogenic_factor_notes():
    ...
    factors = {
        "Wind": {
            ...
            "symptoms_skin": ["Aversion to cold", "Fever", "Sore throat", "Sneezing", "Runny nose", "Occipital stiffness", "Floating pulse"],
            "symptoms_channel": ["Stiffness", "Rigidity", "Sudden muscle contraction"],
            "symptoms_joint": ["Joint pain that moves from place to place, especially in the upper part of the body (Wind-Bi)"]
        },
        "Cold": {
            "yin_yang": "Yin",
            "season": "Winter",
        ...
        "Dampness": {
            ...
            "symptoms_joint": ["Pain", "Heaviness and swelling of the joints, especially of the lower part of the body (Damp-Bi)"],
            "symptoms_other": ["Acute urinary discomfort", "Acute vaginal discharge", "Acute skin disease with vesicles or papules", "Acute digestive upsets"]
        },
        "Dryness": {
            "yin_yang": "Yang",
            "season": "Autumn",
        ...
        "Fire": {
            ...
            "symptoms": ["Aversion to heat", "High fever", "Sweating", "Mental confusion", "Thirst", "Overflowing-rapid pulse"],
