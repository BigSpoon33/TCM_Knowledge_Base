...
class DiagnosisExtractor:
    ...
    def create_markdown(self, section_name: str, text: str, 
                       images: List[str], start_page: int, end_page: int) -> str:
    ...
    def extract_section(self, section_name: str, 
                       start_page: int = 0, end_page: int = 0,
        ...
        markdown = self.create_markdown(section_name, text, images, 
                                       start_page, end_page)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract diagnostic sections from Maciocia book"
    )
    parser.add_argument(
        "--pdf",
    ...
    parser.add_argument(
        "--section",
        choices=["tongue", "pulse", "questioning", "all"],
        default="all",
    ...
    parser.add_argument(
        "--start-page",
        type=int,
        help="Override start page"
    )
    parser.add_argument(
        "--end-page",
        type=int,
        help="Override end page"
    )
    parser.add_argument(
        "--no-images",
        action="store_true",
    ...
    sections = {
        ...
        "questioning": "Diagnosis by Questioning"
    }
