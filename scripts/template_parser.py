...
class TemplateParser:
    ...
    def get_heading_list(self, headings_tree: List[Dict] = None, 
                        include_level: bool = False) -> List[str]:
        """
    ...
    def get_section_headings_only(self, min_level: int = 2, 
                                  max_level: int = 3) -> List[str]:
        """
