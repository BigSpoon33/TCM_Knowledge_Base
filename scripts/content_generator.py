...
class ContentGenerator:
    ...
    def generate_section(self, heading: Dict[str, Any], topic: str, 
                        project: str, context: str) -> str:
        """
    ...
    def generate_all_sections(self, headings: List[Dict], topic: str,
                             project: str, context: str) -> Dict[str, str]:
        """
    ...
    def _build_section_prompt(self, heading_text: str, level: int,
                             topic: str, project: str, context: str) -> str:
        """
