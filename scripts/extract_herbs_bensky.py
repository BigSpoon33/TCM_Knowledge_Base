...
class HerbExtractor:
    ...
    def _parse_herb_info(self, text: str, herb_name: str):
        ...
        # Channels
        channel_patterns = ['Lung', 'Spleen', 'Stomach', 'Heart', 'Liver', 'Kidney', 
                           'Large Intestine', 'Small Intestine', 'Bladder', 'Gall Bladder',
        ...
        functions = []
        function_section = re.search(r'(Actions?|Functions?|Indications?)[:\s]+(.*?)(?=\n\n|\nCautions?|\nContraindications?)', 
