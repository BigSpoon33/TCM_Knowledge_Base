...
class FigureExtractor:
    ...
    def extract_section(self, start_page: int, end_page: int, section_title: str):
        ...
        md_content = self._create_markdown(section_title, start_page, end_page, subsections, pages_data)
    ...
    def _extract_page_with_figures(self, page, page_num, section_title):
        ...
        return {"page_num": page_num, "text": page_text, "figures": figures}
    ...
    def _create_markdown(self, title: str, start_page: int, end_page: int, subsections: list, pages_data: list):
