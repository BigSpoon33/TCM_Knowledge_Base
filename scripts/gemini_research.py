...
class GeminiDeepResearch:
    ...
    def deep_research(self, topic: str, project: str, depth: str = "comprehensive") -> dict[str, Any]:
        """
    ...
    def _build_research_prompt(self, topic: str, project: str, depth: str) -> str:
...
"""
    ...
    def save_research(self, research_result: dict[str, Any], output_path: Path):
        """
    ...
    def load_research(self, input_path: Path) -> dict[str, Any]:
        ...
        if input_path.suffix == ".json":
            ...
            return {"content": research_content, "loaded_from": str(input_path)}
...
def main():
    ...
    parser.add_argument("--no-search", action="store_true", help="Disable search grounding")
    ...
    result = researcher.deep_research(topic=args.topic, project=args.project, depth=args.depth)
