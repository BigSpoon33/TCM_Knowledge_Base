...
def split_five_elements_file(filepath: Path, output_dir: Path):
    ...
    for i in range(1, len(sections), 2):
        if i + 1 < len(sections):
            ...
            individual_content = create_individual_pattern(pattern_name, header, pattern_content, frontmatter)
...
if __name__ == "__main__":
    ...
    print(
        '   python scripts/enhance_pattern_single_call.py "[Pattern Name]" --pattern-dir "TCM_Patterns/Five Elements Patterns"'
    )
