...
def main():
    ...
    parser.add_argument(
        "--pdf",
        default="Books/Chinese Herbal Formulas and Applications Pharmacological Effects Clinical Research by John K. Chen Tina T. Chen Minh Nguyen Lily Huang Jimmy Chang Rick Friesen Chien-Hui Liao (z-lib.org).pdf",
    )
