...
from ..utils.validation import validate_api_key, find_script_path
...
def research_topic(
    ...
    try:
        if deep:
            ...
            from rich.progress import Progress, BarColumn, TextColumn, SpinnerColumn, ProgressColumn
            ...
            process = subprocess.Popen(
                cmd_args, cwd=kb_path, stdout=subprocess.PIPE,
