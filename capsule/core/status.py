...
class Status:
    """
    Service for retrieving status information about the vault and installed capsules.
    """
    ...
    def get_vault_summary(self) -> dict[str, Any]:
        """
        Returns a summary of the vault status.

        Returns:
            Dict containing capsule count and list of capsules.
        """
        capsules = self.get_installed_capsules()

        return {"capsule_count": len(capsules), "capsules": capsules}
